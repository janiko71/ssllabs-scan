...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:my="my:my" exclude-result-prefixes="my">
	...
	<my:texts>
		...
		<idalgo lang="en">Id</idalgo>
		<idalgo lang="fr">Id</idalgo>
		<strength lang="en">Strength</strength>
		<strength lang="fr">Force</strength>
	</my:texts>
...
<html>
  ...
  <body>
	...
	<!-- Certificate -->
	<h3><xsl:value-of select="$vTexts/certificate[@lang = $pLang]"/></h3>
	...
	<!-- Algos supportés -->
	<h3><xsl:value-of select="$vTexts/supportedAlgos[@lang = $pLang]"/></h3>
	<table class='table_algos'>
	  <tr>
		<th style="width:80px;" ><xsl:value-of select="$vTexts/idalgo[@lang = $pLang]"/></th>
		...
		<th style="width:80px;" ><xsl:value-of select="$vTexts/strength[@lang = $pLang]"/></th>
		<th style="width:80px;" ><xsl:value-of select="$vTexts/dhebits[@lang = $pLang]"/></th>
	  </tr>
	  ...
	  <tr>
		...
		<td class='grey'><xsl:value-of select="@strength"/></td>
		<td class='grey'><xsl:value-of select="@dhebits"/></td>
	  </tr>
	  </xsl:for-each>
	</table>
